...
const styles = StyleSheet.create({ screen: { gap: spacing.section }, group: { backgroundColor: colors.white, borderRadius: 18, overflow: 'hidden' }, setting: { minHeight: 88, flexDirection: 'row', alignItems: 'center', gap: spacing.small, padding: spacing.small }, settingIcon: { width: 48, height: 48, borderRadius: 16, backgroundColor: colors.creamDeep, alignItems: 'center', justifyContent: 'center' }, copy: { flex: 1, gap: 2 }, cardTitle: { flexDirection: 'row', alignItems: 'center', gap: spacing.compact } });
