...
export default function ProfileScreen() {
  ...
  return (
    <Screen contentContainerStyle={styles.screen}>
      ...
      <View style={styles.sectionHeading}><Text variant="title2">앱 관리</Text><Text color={colors.neutral800}>알림과 화면 동작을 내게 맞게 설정해요.</Text></View>
      <View style={styles.menu}><MenuRow icon="gearshape.fill" title="설정" body="알림, 진동, 소리, 화면 움직임" onPress={() => router.push('/settings')} /></View>
    </Screen>
  );
}
